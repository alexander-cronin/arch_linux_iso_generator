...
alias gitpro='atom ~/My_Source_Code/git_projects'

# Open "Atom" editor in "~/Local_Projects"
alias localpro='atom ~/My_Source_Code/Local_Projects'
...
# Generate New C++ Project Skeleton
alias newcpp='~/Shell_Scripts/./cpp_project_generator.bash'
